...
public class RetrievedBillingCollectionUnit : AbstractModel
{
    /// <summary> The detailed billing information. </summary>
    [JsonPropertyName("cobranca")]
    public BillingCollectionRetrievingResponse Billing { get; set; }
    ...
    public RetrievedBillingCollectionUnit(BillingCollectionRetrievingResponse billing, BillingBilletRetrievingResponse slip, BillingPixRetrievingResponse pix)
    {
        Billing = billing;
        Slip = slip;
        Pix = pix;
    ...
    public RetrievedBillingCollectionUnit() { }
}
