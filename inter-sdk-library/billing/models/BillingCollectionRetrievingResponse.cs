...
public class BillingCollectionRetrievingResponse : AbstractModel
{
...
/// <summary> Constructs a new BillingRetrievingResponse with specified values. </summary>
    ...
    public BillingCollectionRetrievingResponse(string requestCode,
                                     string yourNumber,
                                     string issueDate,
                                     string dueDate,
                                     string nominalValue,
    ...
    public BillingCollectionRetrievingResponse() { }
}
